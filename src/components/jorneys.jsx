function Jorney(){
  return (
    <div>
      <h2>A Jornada do Encantamento</h2>
      <div>
        <h3>
          Como marcar sua vida em 4 anos?
        </h3>
        <p>
      ...
      <div>
        <h3>
          Grandes Empresas, Pequenos Passos
        </h3>
        <p>
      ...
      <div>
        <h3>
          Como encantar um cliente sem ter contato com ele?
        </h3>
        <p>
